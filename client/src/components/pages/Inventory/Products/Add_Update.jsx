...
const AddUpdateContent = ({
    ...
    if (simpleMode) {
        return (
            <div>
                <Grid container direction="row" columnSpacing={2} rowSpacing={2} sx={{ mb: 2 }}>
                    <Grid item xs={12}>
                        <Grid container justifyContent="center">{imgPreview()}</Grid>
                    </Grid>
            ...
            <Grid container direction="row" columnSpacing={{ lg: 2, xl: 2, sm: 2 }} rowSpacing={2} sx={{ mt: .5 }}>
                ...
                <Grid item lg={12} xl={12} sm={12} xs={12}>
                    <TextField
                        name="description"
                        label="Description"
                        placeholder="Description of the Product (Optional)"
                        size="small"
                        minRows={2}
                        maxRows={6}
                        multiline
